...
******************/
function pionusnews_post_categories(){
   $pionusnews_categories = array();
   $post_categories=get_categories(array(
	...
	if (is_array($post_categories) || is_object($post_categories))
	{
     foreach($post_categories as $category) { 
        $pionusnews_categories[$category->name] = $category->name;
        //$pionusnews_categories[$category->name] = $category->cat_ID;
	} 
   }
   return $pionusnews_categories;  
}

/******************
Post Categories List By ID
******************/
function pionusnews_post_categories_ID(){
   $pionusnews_categories = array();
   $post_categories=get_categories(array(
    'hide_empty' => false
	) );
...
function pionusnews_default_category(){
...
*****************/
function pionusnews_home_slider_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		'post_style' => 1,
        'itemcount' => 3,
        'orderby' => 'title',
...
$list .='<div>
			<article class="style3 single ';if($post_style!=2){ $list .='text-center '; } $list .='no-margin">
					...
					<div class="post-thumb">
						...
						';if($post_style==2){ $list .='<div class="small-title cat">' . pionusnews_category_styles() . '</div>'; } $list .='
						<div class="post-excerpt">
							';if($post_style!=2){ $list .='<div class="small-title cat">' . pionusnews_category_styles() . '</div>'; }
							...
							<div class="meta">
								<span class="author">'.get_avatar( get_the_author_meta('email'), '25' ).' '.__("by", "pantograph").' '.get_the_author_posts_link().'</span>';
								if($post_style!=2){ $list .='
								<span>'.__("on", "pantograph").' '.get_the_time('M j, Y').'</span>';
								} if($post_style==2){ $list .='
...
$list .='<div><style>
		...
		} if($slider_autoplay=='no'){ $list .='<script>
						jQuery(function($) {
							$(".home-slider'.$random_number.'").not(".slick-initialized").slick({
        dots: false,
        infinite: true,
        speed: 300,
        slidesToShow: 1,
...
add_shortcode('pionusnews_home_slider', 'pionusnews_home_slider_shortcode');

/*****************
Shortcode For Category Post List 
*****************/

function pionusnews_category_post_list_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
), $atts) );
...
<div class="col-md-3">
	<div class="header-post">
		...
		<h4 class="title_not_for_mobile"><a href="'.get_permalink().'">' . get_the_title() . '</a></h4>
		<h4 class="mobile_limit_title"><a href="'.get_permalink().'">' . mb_strimwidth( get_the_title(), 0, 30, '...' ) . '</a></h4>
		<p class="hidden-xs">' . pionusnews_excerpt(20) . '</p>
	</div>
</div>
'; 
endwhile;
...
add_shortcode('pionusnews_category_post_list', 'pionusnews_category_post_list_shortcode');
...
function pionusnews_category_tab_post_list_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'heading1' => '',
        'heading2' => '',
        ...
        'heading7' => '',
        'heading8' => '',
        'category1' => pionusnews_default_category(),
        'category2' => pionusnews_default_category(),
        'category3' => pionusnews_default_category(),
        'category4' => pionusnews_default_category(),
        'category5' => pionusnews_default_category(),
        'category6' => pionusnews_default_category(),
        'category7' => pionusnews_default_category(),
        'category8' => pionusnews_default_category()
), $atts) );
$q1 = new WP_Query(
array(
		'post_type' => $type,
...
<div class="col-md-3 tabsitem no-padding">
	<ul class="tabs-mobile-menu">';
	if($heading1){
    $category_id_1 = get_cat_ID($category1);
    $category_link_1 = get_category_link( $category_id_1 );
	$list .= '<li><a href="'.$category_link_1.'">'.esc_attr( $heading1 ).'</a></li>';
	}
	if($heading2){
    $category_id_2 = get_cat_ID($category2);
    $category_link_2 = get_category_link( $category_id_2 );
	$list .= '<li><a href="'.$category_link_2.'">'.esc_attr( $heading2 ).'</a></li>';
	}
	if($heading3){
    $category_id_3 = get_cat_ID($category3);
    $category_link_3 = get_category_link( $category_id_3 );
	$list .= '<li><a href="'.$category_link_3.'">'.esc_attr( $heading3 ).'</a></li>';
	}
	if($heading4){
    $category_id_4 = get_cat_ID($category4);
    $category_link_4 = get_category_link( $category_id_4 );
	$list .= '<li><a href="'.$category_link_4.'">'.esc_attr( $heading4 ).'</a></li>';
	}
	if($heading5){
    $category_id_5 = get_cat_ID($category5);
    $category_link_5 = get_category_link( $category_id_5 );
	$list .= '<li><a href="'.$category_link_5.'">'.esc_attr( $heading5 ).'</a></li>';
	}
	if($heading6){
    $category_id_6 = get_cat_ID($category6);
    $category_link_6 = get_category_link( $category_id_6 );
	$list .= '<li><a href="'.$category_link_6.'">'.esc_attr( $heading6 ).'</a></li>';
	}
	if($heading7){
    $category_id_7 = get_cat_ID($category7);
    $category_link_7 = get_category_link( $category_id_7 );
	$list .= '<li><a href="'.$category_link_7.'">'.esc_attr( $heading7 ).'</a></li>';
	}
	if($heading8){
    $category_id_8 = get_cat_ID($category8);
    $category_link_8 = get_category_link( $category_id_8 );
	$list .= '<li><a href="'.$category_link_8.'">'.esc_attr( $heading8 ).'</a></li>';
	}	
	$list .= '</ul>';	
	$list .= '<ul class="tabs-menu">';
	if($heading1){
...
add_shortcode('pionusnews_category_tab_post_list', 'pionusnews_category_tab_post_list_shortcode');
...
function pionusnews_post_block_1_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
        'taboption' => 'no',
		...
		'blockborder' => 'no'
			...
			if($blockborder=='yes'){ $blockborder='pionusnews-make-border';}else{$blockborder='';}
			...
			if($blockcategorybackground){
				include('css/colors/p1/blockcategorybackground.php');
				}
			if($blockcolor){
	   ...
	   $list .= '<div class="loader'.$current_time.'" style="display:none;"></div>
					...
					$list .= '<article class="article-home sectiononestyle1 style-alt">
								...
								<div class="post-excerpt">
									...
									<div class="meta">
										<span>'.__("by", "pantograph").' '.get_the_author_posts_link().'</span>
										<span>'.__("on", "pantograph").' '.get_the_time('M j, Y').'</span>
										<span class="comment"> <a class="meta-link" href="'.get_the_permalink().'"><i class="far fa-comment"></i> '.get_comments_number().'</a> </span>
									</div>
									<p>' . pionusnews_excerpt($wordlimit) . '</p>
								</div>
							</article>';
					endwhile; endif;
					...
					$args = array('post_type' => 'post', 'post__not_in' => $ar, 'posts_per_page' => $showpost_item, 'category_name' => $category, 'orderby' => $orderby, 'order' => $order);
					}
					...
					$list .='<b class="next-link disabled">'.esc_html__('Prev', 'pantograph').'</b>';
					} 
					if($next_link){
					$list .='<b class="prev-link">'.get_next_posts_link('Next').'</b>';
					}else{ 	
					$list .='<b class="prev-link disabled">'.esc_html__(' Next', 'pantograph').'</b>';
					} 				
					$list .='</div>';
					$list .='</div>';
					...
					$list .='<script>
						jQuery(function($) {
							$("#mynewcontent'.$current_time.$topitem.'").on("click", "#mynewpagination'.$current_time.$topitem.' a", function(e){
								...
								$(".fixedheight").height($("#mynewcontent'.$current_time.$topitem.'").height());
	   ...
	   $list .= '<div class="loader'.$current_time.'" style="display:none;"></div>
				<div id="mynewcontent'.$current_time.$dropdownitem.'mdiffer">
					...
					$args = array('post_type' => 'post', 'paged' => $paged, 'post__not_in' => $ar, 'posts_per_page' => $showpost_item, 'category_name' => $dropdowncatname, 'orderby' => $orderby, 'order' => $order);
					}
					...
					$("#mynewcontent'.$current_time.$dropdownitem.'mdiffer").on("click", "#mynewpagination'.$current_time.$dropdownitem.'mdiffer a", function(e){
						e.preventDefault();
						$(".loader'.$current_time.'").show();
						$(".fixedheight").height($("#mynewcontent'.$current_time.$dropdownitem.'").height());
						var link = $(this).attr("href");
	   ...
	   $list .= '<div class="loader'.$current_time.'" style="display:none;"></div>
			...
			$list .= '<article class="article-home sectiononestyle1 style-alt">
						...
						<div class="post-excerpt">
							...
							<p>' . pionusnews_excerpt($large_post_excerpt_limit) . '</p>
						</div>
					</article>';
			endwhile; endif;
			...
			if (empty($ar)) {	
				...
				$args = array('post_type' => 'post', 'paged' => $paged, 'post__not_in' => $ar, 'posts_per_page' => $showpost_item, 'category_name' => $category, 'orderby' => $orderby, 'order' => $order);
			}
			...
			$list .='<script>
				jQuery(function($) {
					$("#mynewcontent'.$current_time.'").on("click", "#mynewpagination'.$current_time.' a", function(e){
						e.preventDefault();
						$(".loader'.$current_time.'").show();
						$(".fixedheight").height($("#mynewcontent'.$current_time.'").height());
...
add_shortcode('pionusnews_post_block_1_post', 'pionusnews_post_block_1_shortcode');
...
function pionusnews_post_block_2_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			$the_query = new WP_Query( array('post_type' => 'post', 'post__not_in' => $ar, 'posts_per_page' => $showpost_item, 'category_name' => $category, 'orderby' => $orderby, 'order' => $order));
			}
			...
			$list .= '<article class="style2">
				...
				if($nextprevbtn=='yes'){
					if($showloadmore >= 1){
					$list .= '<div class="post_block_2_posts_loadmore'.$current_time.' loadmorebtn">'.esc_html__('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
					...
					jQuery(function($) {
						$("body").on("click", ".post_block_2_posts_loadmore'.$current_time.'", function() {
							...
							$(".post_block_2_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");
							$.post(ajaxurl, data, function(response) {
								if(response != "") {
								$(".post_block_2_posts'.$current_time.'").append(response);
								page++;
								$(".post_block_2_posts'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
								} else {
...
add_shortcode('pionusnews_post_block_2_post', 'pionusnews_post_block_2_shortcode');

/*****************
Post Block 3 Post List 
*****************/

function pionusnews_post_block_3_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			$list .= '<div class="col-md-4 col-sm-4">
				...
				if($nextprevbtn=='yes'){
				if($showloadmore >= 1){
				$list .= '<div class="post_block_3_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
				$list .='
				...
				jQuery(function($) {
					$("body").on("click", ".post_block_3_posts_loadmore'.$current_time.'", function() {
						...
						$(".post_block_3_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

						$.post(ajaxurl, data, function(response) {
							if(response != "") {
							$(".post_block_3_posts'.$current_time.'").append(response);
							page++;
							$(".post_block_3_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
							} else {
...
add_shortcode('pionusnews_post_block_3_post', 'pionusnews_post_block_3_shortcode');
...
function pionusnews_post_block_4_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			if($nextprevbtn=='yes'){
				if($showloadmore >= 1){
				$list .= '<div class="post_block_4_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
				$list .='
				<script type="text/javascript">
				var ajaxurl = "'.admin_url('admin-ajax.php').'";
				var page = 2;
				...
				jQuery(function($) {
					$("body").on("click", ".post_block_4_posts_loadmore'.$current_time.'", function() {
						...
						$(".post_block_4_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

						$.post(ajaxurl, data, function(response) {
							if(response != "") {
							$(".post_block_4_posts'.$current_time.'").append(response);
							page++;
							$(".post_block_4_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
							} else {
...
add_shortcode('pionusnews_post_block_4_post', 'pionusnews_post_block_4_shortcode');
...
function pionusnews_post_block_5_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			if($imageanimate=='yes'){ $bgimagecls='bg-img';}else{$bgimagecls='';}
			if($blockborder=='yes'){ $blockborder='pionusnews-make-border';
			}else{$blockborder='';}
			...
			$list .= '<div class="col-md-6 col-sm-6">
				...
				if($nextprevbtn=='yes'){
				$list .= '<div class="post_block_5_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
				$list .='
				<script type="text/javascript">
				var ajaxurl = "'.admin_url('admin-ajax.php').'";
				var page = 2;
				...
				jQuery(function($) {
					$("body").on("click", ".post_block_5_posts_loadmore'.$current_time.'", function() {
						...
						$(".post_block_5_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

						$.post(ajaxurl, data, function(response) {
							if(response != "") {
							$(".post_block_5_posts'.$current_time.'").append(response);
							page++;
							$(".post_block_5_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
							} else {
...
add_shortcode('pionusnews_post_block_5_post', 'pionusnews_post_block_5_shortcode');
...
function pionusnews_post_block_6_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'taboption' => 'no',
						...
						$list .='<script>
							jQuery(function($) {
								$("#mynewcontent'.$current_time.$topitem.'").on("click", "#mynewpagination'.$current_time.$topitem.' a", function(e){
									e.preventDefault();
									$(".loader'.$current_time.'").show();
									$(".fixedheight_b6").height($("#mynewcontent'.$current_time.$topitem.'").height());
									var link = $(this).attr("href");
									$("#mynewcontent'.$current_time.$topitem.'").fadeOut("slow", function(){
										$(this).load(link + " #mynewcontent'.$current_time.$topitem.'", function() {
											$(this).fadeIn("slow");
											$(".loader'.$current_time.'").hide();
											$(".fixedheight_b6").height("auto");
										});
									});
								});
								});
				...
				$list .='<script>
					jQuery(function($) {
						$("#mynewcontent'.$current_time.$dropdownitem.'mdiffer6").on("click", "#mynewpagination'.$current_time.$dropdownitem.'mdiffer6 a", function(e){
							e.preventDefault();
							$(".loader'.$current_time.'").show();
							$(".fixedheight_b6").height($("#mynewcontent'.$current_time.$dropdownitem.'").height());
							var link = $(this).attr("href");
				...
				$list .='<script>
					jQuery(function($) {
						$("#mynewcontent'.$current_time.'").on("click", "#mynewpagination'.$current_time.' a", function(e){
							...
							$(".loader'.$current_time.'").show();
							var link = $(this).attr("href");
							$(".fixedheight_b6").height($("#mynewcontent'.$current_time.'").height());
							$("#mynewcontent'.$current_time.'").fadeOut("slow", function(){
								$(this).load(link + " #mynewcontent'.$current_time.'", function() {
									$(this).fadeIn("slow");
									$(".loader'.$current_time.'").hide();
...
add_shortcode('pionusnews_post_block_6_post', 'pionusnews_post_block_6_shortcode');

/*****************
Post Block 7 Post List 
*****************/

function pionusnews_post_block_7_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			if($blockcategorybackground){
							include('css/colors/p7/blockcategorybackground.php');
						}
			}
			if((!empty($blockheadingcolor)) || (!empty($blockheadingbackgroundcolor)) || (!empty($blockbordercolor)) || (!empty($blockbackgroundcolor)) || (!empty($blockposttitlecolor)) || (!empty($blockcolor)) || (!empty($blocktextcolor)) || (!empty($blockdatecolor))){
			if($blockheadingcolor){
...
add_shortcode('pionusnews_post_block_7_post', 'pionusnews_post_block_7_shortcode');
...
function pionusnews_post_block_8_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_8_post', 'pionusnews_post_block_8_shortcode');
...
function pionusnews_post_block_9_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_9_post', 'pionusnews_post_block_9_shortcode');
...
function pionusnews_post_block_10_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			if($nextprevbtn=='yes'){
				if($showloadmore >= 1){
				$list .= '<div class="post_block_10_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
				$list .='
				<script type="text/javascript">
				var ajaxurl = "'.admin_url('admin-ajax.php').'";
				var page = 2;
				...
				jQuery(function($) {
					$("body").on("click", ".post_block_10_posts_loadmore'.$current_time.'", function() {
						...
						$(".post_block_10_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

						$.post(ajaxurl, data, function(response) {
							if(response != "") {
							$(".post_block_10_posts'.$current_time.'").append(response);
							page++;
							$(".post_block_10_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
							} else {
...
add_shortcode('pionusnews_post_block_10_post', 'pionusnews_post_block_10_shortcode');
...
function pionusnews_post_block_11_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_11_post', 'pionusnews_post_block_11_shortcode');
...
function pionusnews_post_block_12_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_12_post', 'pionusnews_post_block_12_shortcode');
...
function pionusnews_post_block_13_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_13_post', 'pionusnews_post_block_13_shortcode');
...
function pionusnews_post_block_14_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			if($blockcategorybackground){
							include('css/colors/p14/blockcategorybackground.php');
						}
			}	
			...
			if($nextprevbtn=='yes'){
				if($showloadmore >= 1){
			$list .= '<div class="post_block_14_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
			$list .='
				<script type="text/javascript">
				var ajaxurl = "'.admin_url('admin-ajax.php').'";
				var page = 2;
				...
				jQuery(function($) {
					$("body").on("click", ".post_block_14_posts_loadmore'.$current_time.'", function() {
						...
						$(".post_block_14_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

						$.post(ajaxurl, data, function(response) {
							if(response != "") {
							$(".post_block_14_posts'.$current_time.'").append(response);
							page++;
							$(".post_block_14_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
							} else {
...
add_shortcode('pionusnews_post_block_14_post', 'pionusnews_post_block_14_shortcode');

/*****************
Post Block 15 Post List 
*****************/

function pionusnews_post_block_15_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			if($showloadmore >= 1){
			$list .= '<div class="post_block_15_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
			$list .='
					<script type="text/javascript">
					var ajaxurl = "'.admin_url('admin-ajax.php').'";
					var page = 2;
					...
					jQuery(function($) {
						$("body").on("click", ".post_block_15_posts_loadmore'.$current_time.'", function() {
							...
							$(".post_block_15_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

							$.post(ajaxurl, data, function(response) {
								if(response != "") {
								$(".post_block_15_posts'.$current_time.'").append(response);
								page++;
								$(".post_block_15_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
								} else {
...
add_shortcode('pionusnews_post_block_15_post', 'pionusnews_post_block_15_shortcode');
...
function pionusnews_post_block_16_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			if($nextprevbtn=='yes'){
			if($showloadmore >= 1){
			$list .= '<div class="post_block_16_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
			$list .='
			<script type="text/javascript">
			var ajaxurl = "'.admin_url('admin-ajax.php').'";
			var page = 2;
			...
			$("body").on("click", ".post_block_16_posts_loadmore'.$current_time.'", function() {
				...
				$(".post_block_16_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

				$.post(ajaxurl, data, function(response) {
					if(response != "") {
					$(".post_block_16_posts'.$current_time.'").append(response);
					page++;
					$(".post_block_16_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
					} else {
...
add_shortcode('pionusnews_post_block_16_post', 'pionusnews_post_block_16_shortcode');
...
function pionusnews_post_block_17_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_17_post', 'pionusnews_post_block_17_shortcode');
...
function pionusnews_post_block_18_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_18_post', 'pionusnews_post_block_18_shortcode');
...
function pionusnews_post_block_19_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		$list .= '<div class="col-md-6 col-sm-6">
						<article class="style4 style-alt">
							...
							'.$videoicon.'
								<div class="small-title cat wow fadeIn" style="visibility: visible; animation-name: fadeIn;">' . pionusnews_category_styles() . '</div>
...
add_shortcode('pionusnews_post_block_19_post', 'pionusnews_post_block_19_shortcode');
...
function pionusnews_post_block_20_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_20_post', 'pionusnews_post_block_20_shortcode');

/*****************
Post Block 21 Post List 
*****************/

function pionusnews_post_block_21_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_21_post', 'pionusnews_post_block_21_shortcode');
...
function pionusnews_post_block_22_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_22_post', 'pionusnews_post_block_22_shortcode');
...
function pionusnews_post_block_23_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
        'large_post_id' => '',
		...
		'blockborder' => 'no'
			...
			if($nextprevbtn=='yes'){
			$list .= '<div class="post_block_23_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
			$list .='
			<script type="text/javascript">
			var ajaxurl = "'.admin_url('admin-ajax.php').'";
			var page = 2;
			...
			jQuery(function($) {
				$("body").on("click", ".post_block_23_posts_loadmore'.$current_time.'", function() {
					...
					$(".post_block_23_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

					$.post(ajaxurl, data, function(response) {
						if(response != "") {
						$(".post_block_23_posts'.$current_time.'").append(response);
						page++;
						$(".post_block_23_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
						} else {
...
add_shortcode('pionusnews_post_block_23_post', 'pionusnews_post_block_23_shortcode');
...
function pionusnews_post_block_24_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
        'large_post_id' => '',
...
add_shortcode('pionusnews_post_block_24_post', 'pionusnews_post_block_24_shortcode');
...
function pionusnews_post_block_25_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
        'large_post_id' => '',
		...
		'postid' => ''
			...
			if($nextprevbtn=='yes'){
				if($showloadmore >= 1){
			$list .= '<div class="post_block_25_posts_loadmore'.$current_time.' loadmorebtn margin-top-50">'.esc_html('Load More', 'pantograph').' <i class="fas fa-redo" aria-hidden="true"></i></div>';
			$list .='
			<script type="text/javascript">
			var ajaxurl = "'.admin_url('admin-ajax.php').'";
			var page = 2;
			...
			jQuery(function($) {
				$("body").on("click", ".post_block_25_posts_loadmore'.$current_time.'", function() {
					...
					$(".post_block_25_posts_loadmore'.$current_time.'.loadmorebtn i").addClass("fa-spin");

					$.post(ajaxurl, data, function(response) {
						if(response != "") {
						$(".post_block_25_posts'.$current_time.'").append(response);
						page++;
						$(".post_block_25_posts_loadmore'.$current_time.'.loadmorebtn i").removeClass("fa-spin");
						} else {
...
add_shortcode('pionusnews_post_block_25_post', 'pionusnews_post_block_25_shortcode');

/*****************
Post Block 26 Post List 
*****************/

function pionusnews_post_block_26_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'itemcount' => 5,
		...
		'postid' => ''
			...
			if((!empty($blockcolor)) || (!empty($blockhovercolor)) || (!empty($blockcategorybackground))){
				...
				if($blockcategorybackground){
					include('css/colors/p26/blockcategorybackground.php');
				}
			}
		if((!empty($blockheadingcolor)) || (!empty($blockheadingbackgroundcolor)) || (!empty($blockbordercolor)) || (!empty($blockbackgroundcolor)) || (!empty($blockposttitlecolor)) || (!empty($blockcolor)) || (!empty($blocktextcolor)) || (!empty($blockdatecolor))){
			if($blockheadingcolor){
			...
			$list .= '<div class="row">';
				...
				$list .= '<div class="col-md-4">
					<div class="mini-posts">';
					$arr1 = array($postid);
					if(!empty($the_query1->post->ID)){
					$arr2 = array($the_query1->post->ID);
					} else {
					$arr2 = array();
					}
					$ar = array_merge($arr1,$arr2);
					...
					$the_query2 = new WP_Query( array('post_type' => 'post', 'post__not_in' => $ar, 'posts_per_page' => $showpost_item, 'category_name' => $category, 'orderby' => $orderby, 'order' => $order));
					}
					while ($the_query2->have_posts()) : $the_query2->the_post();
					$featured_img = get_the_post_thumbnail_url(get_the_ID(),'full');
					if($featured_img){
...
add_shortcode('pionusnews_post_block_26_post', 'pionusnews_post_block_26_shortcode');

/*****************
Post Block 27 Post List 
*****************/

function pionusnews_post_block_27_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'itemcount' => 5,
...
add_shortcode('pionusnews_post_block_27_post', 'pionusnews_post_block_27_shortcode');
...
function pionusnews_post_block_28_shortcode($atts, $content = null){
extract( shortcode_atts( array(
        'heading' => 'Heading',
		'p_top' => '',
		'p_bottom' => '',
		...
		'dotted_bg' => 'no',
			...
			$list ='';
			$list .='<div class="post_block_28_for_add unique_class'.$current_time.'" style="padding-top:'.esc_attr($p_top).'; padding-bottom:'.esc_attr($p_bottom).';'; if ( $bg_img != '' ) { $list .= ' background: url('.esc_url( $bg_img ).') no-repeat fixed center top / cover ;'; } $list .= '">';
			$list .= wpb_js_remove_wpautop( $content, true );
			$list .= '</div>';
			$list .= '<div><style>';
			if($dotted_bg=='yes'){
			$list .= '.post_block_28_for_add.unique_class'.$current_time.'{
						background-image: -moz-linear-gradient(45deg, '.esc_attr($bg_color).' 25%, transparent 25%), 
						-moz-linear-gradient(-45deg, '.esc_attr($bg_color).' 25%, transparent 25%), 
						-moz-linear-gradient(45deg, transparent 75%, '.esc_attr($bg_color).' 75%), 
						-moz-linear-gradient(-45deg, transparent 75%, '.esc_attr($bg_color).' 75%);
					background-image: -webkit-gradient(linear, 0 100%, 100% 0, color-stop(.25, '.esc_attr($bg_color).'), color-stop(.25, transparent)), 
						-webkit-gradient(linear, 0 0, 100% 100%, color-stop(.25, '.esc_attr($bg_color).'), color-stop(.25, transparent)), 
						-webkit-gradient(linear, 0 100%, 100% 0, color-stop(.75, transparent), color-stop(.75, '.esc_attr($bg_color).')), 
						-webkit-gradient(linear, 0 0, 100% 100%, color-stop(.75, transparent), color-stop(.75, '.esc_attr($bg_color).'));
					background-image: -webkit-linear-gradient(45deg, '.esc_attr($bg_color).' 25%, transparent 25%), 
						-webkit-linear-gradient(-45deg, '.esc_attr($bg_color).' 25%, transparent 25%), 
						-webkit-linear-gradient(45deg, transparent 75%, '.esc_attr($bg_color).' 75%), 
						-webkit-linear-gradient(-45deg, transparent 75%, '.esc_attr($bg_color).' 75%);
					background-image: -o-linear-gradient(45deg, '.esc_attr($bg_color).' 25%, transparent 25%), 
						-o-linear-gradient(-45deg, '.esc_attr($bg_color).' 25%, transparent 25%), 
						-o-linear-gradient(45deg, transparent 75%, '.esc_attr($bg_color).' 75%), 
						-o-linear-gradient(-45deg, transparent 75%, '.esc_attr($bg_color).' 75%);
					background-image: linear-gradient(45deg, '.esc_attr($bg_color).' 25%, transparent 25%), 
						linear-gradient(-45deg, '.esc_attr($bg_color).' 25%, transparent 25%), 
						linear-gradient(45deg, transparent 75%, '.esc_attr($bg_color).' 75%), 
						linear-gradient(-45deg, transparent 75%, '.esc_attr($bg_color).' 75%);
			...
			$list .= '.post_block_28_for_add.unique_class'.$current_time.'{background-color: '.esc_attr($bg_color).';}';
			}
			$list .= '
			</style></div>';
			return $list;
			}
add_shortcode('pionusnews_post_block_28_post', 'pionusnews_post_block_28_shortcode');
...
function pionusnews_post_block_29_shortcode($atts){
extract( shortcode_atts( array(
		'category' => pionusnews_default_category(),
        'itemcount' => 10,
        'blockcolor' => '',
		...
		'blockborder' => 'no'
			...
			if($blockborder=='yes'){ $blockborder='pionusnews-bknews-border';}else{$blockborder='';}
			
			if($blockposttitlecolor==''){ $blockposttitlecolor='#696969';}else{$blockposttitlecolor=$blockposttitlecolor;}
			if($blockhovercolor==''){ $blockhovercolor='#F26262';}else{$blockhovercolor=$blockhovercolor;}
...
add_shortcode('pionusnews_post_block_29_post', 'pionusnews_post_block_29_shortcode');

/*****************
Post Block 30 Post List 
*****************/

function pionusnews_post_block_30_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_30_post', 'pionusnews_post_block_30_shortcode');

/*****************
Post Block 31 Post List 
*****************/

function pionusnews_post_block_31_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
...
add_shortcode('pionusnews_post_block_31_post', 'pionusnews_post_block_31_shortcode');
...
function pionusnews_post_block_32_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
	...
	$list .= '<div class="col-md-12">
				<div class="style3 article-home">
					<div class="post-thumb">
					'.$videoicon.'	
						<div class="small-title cat" style="padding: 10px;">' . pionusnews_category_styles() . '</div>
		...
		$list .= '<div class="row">';	
		$queryarry3 = array_merge($post_array_new1);
		$post_array_new3 = array();		
		$the_query3 = new WP_Query( array('post_type' => 'post', 'post__not_in' => $queryarry3, 'posts_per_page' => 1, 'category_name' => $category, 'orderby' => $orderby, 'order' => $order));
		while ($the_query3->have_posts()) : $the_query3->the_post();
		$post_array_new3[] = get_the_ID();
...
add_shortcode('pionusnews_post_block_32_post', 'pionusnews_post_block_32_shortcode');

/*****************
Related Post List For Post Category
*****************/

function pionusnews_related_post_for_post_category_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'title_character_limit' => 100,
...
add_shortcode('pionusnews_related_post_for_post_category', 'pionusnews_related_post_for_post_category_shortcode');

/******************
UL Style
******************/
function pionusnews_ul_style_shortcode( $atts, $content = null ) {
    $output = $image_one = '';
	extract( shortcode_atts( array(
    'list_style_title' => '',
    'ul_style' => '',
...
add_shortcode('pionusnews_shortcodes_of_ul', 'pionusnews_ul_style_shortcode');
...
function pionusnews_recent_comment_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
		'itemcount' => 5,
        'current_time' => time(),
...
add_shortcode('pionusnews_recent_comment_post', 'pionusnews_recent_comment_shortcode');
...
function pionusnews_recent_post_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
		'itemcount' => 5,
        'current_time' => time(),
...
add_shortcode('pionusnews_recent_post', 'pionusnews_recent_post_shortcode');

/*****************
Popular Post List 
*****************/

function pionusnews_popular_post_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
		'itemcount' => 5,
        'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			$list .= '<div class="td-module-meta-info">
					   ...
					   <div class="td-module-comments"><a href="'.get_the_permalink().'">'.get_comments_number().'</a></div>
					</div>';
			endwhile;		
			$list .= '</ul>';
...
add_shortcode('pionusnews_popular_post', 'pionusnews_popular_post_shortcode');

/*****************
Post Block 33 Post List 
*****************/

function pionusnews_post_block_33_shortcode($atts){
extract( shortcode_atts( array(
		'type' => 'post',
        'category' => pionusnews_default_category(),
		'current_time' => time(),
		...
		'blockborder' => 'no'
			...
			if((!empty($blockcolor)) || (!empty($blockhovercolor)) || (!empty($blockcategorybackground))){
			if($blockhovercolor){
			include('css/colors/p33/blockhovercolor.php');
			}else{
				
				if($blockcolor){
				include('css/colors/p33/dependent-blockcolor.php');
				}
			}
			
			if($blockcategorybackground){
			include('css/colors/p33/blockcategorybackground.php');
			}
			
			if($blockcolor){
			include('css/colors/p33/blockcolor.php');
			}
			}
			if((!empty($blockheadingcolor)) || (!empty($blockheadingbackgroundcolor)) || (!empty($blockbordercolor)) || (!empty($blockbackgroundcolor)) || (!empty($blockposttitlecolor)) || (!empty($blockcolor)) || (!empty($blocktextcolor)) || (!empty($blockdatecolor))){

			if($blockheadingcolor){
			include('css/colors/p33/blockheadingcolor.php');
			} 
			if($blockheadingbackgroundcolor){
			include('css/colors/p33/blockheadingbackgroundcolor.php');		
			}else{
				if($blockbackgroundcolor){
				include('css/colors/p33/dependent-blockbackgroundcolor.php');	
				}
			}
			if($blockbordercolor){
			include('css/colors/p33/blockbordercolor.php');
			}
			if($blockbackgroundcolor){
			include('css/colors/p33/blockbackgroundcolor.php');
			}
			if($blockposttitlecolor){
			include('css/colors/p33/blockposttitlecolor.php');
			}
			
			if($blocktextcolor){
			include('css/colors/p33/blocktextcolor.php');
			}
			if($blockdatecolor){
			include('css/colors/p33/blockdatecolor.php');
			}
			}
			
		$list ='';
		$list .='<div class="post_block_33 post_block_33'.$current_time.' '.$blockborder.'">';
		if($heading){		
		$list .= '<h3 class="margin-bottom-15"><b>'.$heading.'</b></h3>';
		}
		$list .= '<div class="row style4-4-6">';
		$list .= '
				<div class="column_47 padding-right-none">';
				...
				endwhile;
				$list .= '</div>'; 
				$list .='<div class="padding-left-none padding-right-none">';
				$queryarry4 = $post_array_new3;	
				$post_array_new4 = array();	
				$the_query4 = new WP_Query( array('post_type' => 'post', 'post__not_in' => $queryarry4, 'posts_per_page' => 1, 'category_name' => $category, 'orderby' => $orderby, 'order' => $order));
				while ($the_query4->have_posts()) : $the_query4->the_post();
				$post_array_new4[] = get_the_ID();
				...
				$list .= '<article class="style4 style-alt column_26 padding-right-none padding-left-2-middle">
						<div class="post-thumb">
						'.$videoicon.'	
							<div class="small-title cat">' . pionusnews_category_styles() . '</div>
							<div class="post-excerpt">
				...
				$queryarry5 = array_merge($post_array_new3,$post_array_new4);	
				$the_query5 = new WP_Query( array('post_type' => 'post', 'post__not_in' => $queryarry5, 'posts_per_page' => 1, 'category_name' => $category, 'orderby' => $orderby, 'order' => $order));
				while ($the_query5->have_posts()) : $the_query5->the_post();
				$featured_img = get_the_post_thumbnail_url(get_the_ID(),'full');
				if($featured_img){
				...
				$list .= '<article class="style4 style-alt column_26 padding-left-2-last">
						<div class="post-thumb">
							<div class="small-title cat">' . pionusnews_category_styles() . '</div>
							<div class="post-excerpt">
								<div class="meta">
...
add_shortcode('pionusnews_post_block_33_post', 'pionusnews_post_block_33_shortcode');
