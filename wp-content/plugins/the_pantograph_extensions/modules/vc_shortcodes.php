<?php
/*-----------------------------------------------------------------------------------*/
/* Start Using pantograph Shortcodes in the Visual Composer */
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'pantograph_vc_shortcodes' );
function pantograph_vc_shortcodes() {
...
vc_map( array(
      ...
      "base" => "pantograph_category_post_list",
      ...
      "params" => array(         
		 array(
            ...
            "param_name" => "category",
            "value" => pantograph_post_categories(),
			"std"   => pantograph_default_category(),
...
vc_map( array(
      ...
      "base" => "pantograph_category_tab_post_list",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_1_post",
      ...
      "params" => array(         
		 ...
		 array(
            ...
            "value" => pantograph_post_categories_ID(),
			'dependency' => array(
				 'element' => 'taboption',
				 'value' =>'yes',
			 ),
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_2_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_3_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_4_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_5_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_6_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_7_post",
      "icon" => plugins_url( 'images/block_3.png', __FILE__ ),
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'pantograph'),
      'admin_enqueue_js' => '',
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_8_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_9_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_10_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_11_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_12_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_13_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_14_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_15_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_16_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_17_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_18_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_19_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_20_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_21_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_22_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_23_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_24_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_25_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_26_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_27_post",
...
****************/
vc_map( array(
      "name" => esc_html__("Add Block", 'pantograph'),
      "base" => "pantograph_post_block_28_post",
      "icon" => plugins_url( 'images/vc.png', __FILE__ ),
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'pantograph'),
      'description' => esc_html__('Display Adds for google adsense or others', 'pantograph'),
      "params" => array(
		 array(
            "type" => "textarea_html",            
            "class" => "",
            "heading" => esc_html__("Your add code", 'pantograph'),
            "param_name" => "content",
            "description" => esc_html__('Paste Add code for google adsense or others','pantograph')
         )
      )
   )
);
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_29_post",
      "icon" => plugins_url( 'images/vc.png', __FILE__ ),
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'pantograph'),
      'admin_enqueue_js' => '',
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_30_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_31_post",
...
vc_map( array(
      ...
      "base" => "pantograph_post_block_32_post",
...
vc_map( array(
      ...
      "base" => "pantograph_related_post_for_post_category",
...
vc_map( array(
      ...
      "base" => "pantograph_shortcodes_of_ul",
      ...
      "params" => array(
		 ...
		 array(
            ...
            "param_name" => "features",
            "description" => esc_html__('Start each feature on new line','pantograph')
         )
      )
   )
);
...
vc_map( array(
      ...
      "base" => "pantograph_recent_comment_post",
      "icon" => plugins_url( 'images/block_32.png', __FILE__ ),
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'pantograph'),
      'admin_enqueue_js' => '',
