<div class="inner-content single-image-and-title">
	<div class="container">
	 <?php if(pantograph_get_option('pantograph_on_breadcrumbs') == 1) { ?>
		...
		<div class="row">
			<div class="col-md-8 col-sm-12">
				...
				?>
					<div class="blog-single <?php if ( (!has_post_thumbnail() || (empty($custom_image_url)))) : ?> no-single-image <?php endif; ?>">
						<?php 
					...
					<?php if((!empty($get_image))){ ?>
						...
						<?php }else{ ?>
						<h1 class="h1 <?php if ( (has_post_thumbnail() || (!empty($custom_image_url)))) : ?>class1_for_noimage<?php endif;?>"><?php echo get_the_title(); ?></h1>
						...
						<div class="single-meta <?php if ( (has_post_thumbnail() || (!empty($custom_image_url)))) : ?>class2_for_noimage<?php endif;?>">
							<div class="meta pull-left">
								<span class="author"><?php echo get_avatar( get_the_author_meta('email'), '25' ); ?>
								<?php esc_html_e('By', 'pantograph'); ?> <?php the_author_posts_link(); ?></span>
								<span class="date"><?php esc_html_e('on', 'pantograph'); ?> <?php the_time(get_option('date_format')); ?></span>
