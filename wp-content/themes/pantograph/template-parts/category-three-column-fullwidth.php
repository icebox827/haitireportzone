<?php
$show_posts_per_ids = '';//array(); //Related to pantograph_category_top_posts function only
$exclude_postid = '';//array(9999999); //Related to pantograph_category_top_posts function and also the main query of this cat page.
...
<div class="inner-content three-column-fullwidth">	
		...
		<?php if(($show_hide_breadcrumb==1) || ($cat_data['show_hide_title']==1) || ($cat_data['show_hide_cat_desc']==1)){ ?>
			...
			<?php }	?>
				...
				<?php $top_posts_template = 1; //This variable to use condition - which top-post-template will show there.
				$show_posts_per_ids = $exclude_postid;
				?>
				<?php echo pantograph_category_top_posts($show_posts_per_ids); ?>
