...
?>
<div class="inner-content one-column-general<?php if (!pantograph_is_extensions_plugin_active()) { ?> inactive-plugin<?php } ?>">
	<div class="container">
	...
	<?php if(($show_hide_breadcrumb==1) || ($cat_data['show_hide_title']==1) || ($cat_data['show_hide_cat_desc']==1)){ ?>
		...
		<?php } ?>
	<?php } else { //Extension plugin is not activated ?>
		<div class="row">
			<div class="col-md-12">
				<div class="section-head inactive-plugin">
					<?php
