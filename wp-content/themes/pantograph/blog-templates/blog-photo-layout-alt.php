<?php
/**
 * Template Name: Blog - Photo Layout Alt
 */
...
get_template_part( 'template-parts/pionus/blog-templates/blog-photo-layout-alt', 'pionus' );
} else {
$pantograph_on_breadcrumbs = pantograph_get_option('pantograph_on_breadcrumbs');
?>	
<div class="inner-content one-column-image-title">
		<div class="container">
			<div class="row">
				<div class="col-md-12">	
