...
$MailChimp = new MailChimp(pantograph_get_option('mailchimp_apikey'));

$mailchimp_result = $MailChimp->call('lists/subscribe', array(
													'id'                => pantograph_get_option('mailchimp_listid'),
...
if (isset($mailchimp_result['leid'])) {
	echo '<b>'.esc_html__('Thank You for Subscribing!', 'pantograph').'</b>';
