...
?>
<footer <?php if(($container_bg_style==1) || ($global_white_style==1)){ if($body_bg_img_style){ ?> class="navstyle-for-bg"<?php } } ?>>
	<div class="container">
		<div class="footer-head">
			<div class="row center-content">
				...
				<div class="col-md-4 col-sm-4">
					<p><?php echo esc_textarea( pantograph_get_option('pantograph_subscribe_text') ); ?></p>
				</div>
		...
		<div class="footer-content">
			<div class="row">
				...
				<?php 
					dynamic_sidebar( 'footer_widgets_style2' );
		...
		<div class="footer-bottom">
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<p><?php if(pantograph_get_option('copy_text') != '') { ?><?php echo esc_textarea( pantograph_get_option('copy_text') ); ?><?php } else { ?><?php esc_html_e('Copyright &copy; 2017 yourdomian.', 'pantograph'); ?><?php } ?></p>
