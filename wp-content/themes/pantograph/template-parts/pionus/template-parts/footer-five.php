...
?>
<footer class="footer2 pionus-footer5<?php if(($container_bg_style==1) || ($global_white_style==1)){ if(($body_bg_img_style) || ($body_bg_img_style_to)){ ?> navstyle-for-bg<?php } } ?>"<?php if($pionusnews_footer_top_mg){ ?> style="margin-top:<?php echo esc_attr($pionusnews_footer_top_mg); ?> !important;"<?php } ?>>
	<div class="container">
		<div class="<?php if((pionusnews_get_option('footer_logo_url') != '') || (pionusnews_get_option('pionusnews_footer_short_desc') != '') || (pionusnews_get_option('search_on_off_footer') == 1) || is_active_sidebar( 'footer_widgets' ) ) { echo 'footer-content'; } ?>">
			<div class="row">
			<?php if ( (pionusnews_get_option('pionusnews_footer_widgetized_area') == 1)
				...
				<div class="col-md-2 col-sm-2">
					...
					<li><a href="<?php echo esc_url( pionusnews_get_option('social_facebook') ); ?>"><i class="fab fa-facebook-f" style="position: inherit; color: inherit;"></i> &nbsp;<?php esc_html_e( 'Facebook', 'pantograph'); ?></a></li>
					<?php } if(pionusnews_get_option('social_twitter') != '') { ?>
					<li><a href="<?php echo esc_url( pionusnews_get_option('social_twitter') ); ?>"><i class="fab fa-twitter" style="position: inherit; color: inherit;"></i> &nbsp;<?php esc_html_e( 'Twitter', 'pantograph'); ?></a></li>
					<?php } if(pionusnews_get_option('social_googleplus') != '') { ?>
					<li><a href="<?php echo esc_url( pionusnews_get_option('social_googleplus') ); ?>"><i class="fab fa-google-plus-g" style="position: inherit; color: inherit;"></i> &nbsp;<?php esc_html_e( 'Google +', 'pantograph'); ?></a></li>
					<?php } if(pionusnews_get_option('social_instagram') != '') { ?>
					<li><a href="<?php echo esc_url( pionusnews_get_option('social_instagram') ); ?>"><i class="fab fa-instagram" style="position: inherit; color: inherit;"></i> &nbsp;<?php esc_html_e( 'Instagram', 'pantograph'); ?></a></li>
					<?php } if(pionusnews_get_option('social_utube') != '') { ?>
					<li><a href="<?php echo esc_url( pionusnews_get_option('social_utube') ); ?>"><i class="fab fa-youtube" style="position: inherit; color: inherit;"></i> &nbsp;<?php esc_html_e( 'Youtube', 'pantograph'); ?></a></li>
					<?php } if(pionusnews_get_option('social_linkedin') != '') { ?>
					<li><a href="<?php echo esc_url( pionusnews_get_option('social_linkedin') ); ?>"><i class="fab fa-linkedin-in" style="position: inherit; color: inherit;"></i> &nbsp;<?php esc_html_e( 'Linkedin', 'pantograph' ); ?></a></li>
					<?php } ?>
					</ul>
				</div>
				<?php } ?>
