...
?>
<footer class="pionus-footer1<?php if(($container_bg_style==1) || ($global_white_style==1)){ if(($body_bg_img_style) || ($body_bg_img_style_to)){ ?> navstyle-for-bg<?php } } ?>"<?php if($pionusnews_footer_top_mg){ ?> style="margin-top:<?php echo esc_attr($pionusnews_footer_top_mg); ?> !important;"<?php } ?>>
	<div class="container">
		<div class="footer-head">
			<div class="row center-content">
				<div class="col-md-2 col-sm-3">
					<h3><?php esc_html_e( 'Subscribe', 'pantograph'); ?></h3>
				</div>
				<div class="col-md-4 col-sm-4">
					<p><?php echo esc_textarea( pionusnews_get_option('pionusnews_subscribe_text') ); ?></p>
				</div>
		...
		<div class="footer-bottom">
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<p><?php if(pionusnews_get_option('copy_text') != '') { ?><?php echo esc_textarea( pionusnews_get_option('copy_text') ); ?><?php } else { ?><?php esc_html_e('Copyright &copy; 2017 yourdomian.', 'pantograph'); ?><?php } ?></p>
				...
				<div class="col-md-6 col-sm-6 text-right">
					<div class="footer-social2">
						<?php esc_html_e( 'Follow us:', 'pantograph'); ?>
