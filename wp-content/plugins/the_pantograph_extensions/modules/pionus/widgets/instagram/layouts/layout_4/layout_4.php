...
?>
<ul id="scroller_layout_4" class="<?php echo esc_attr( $ulclass ).' '.esc_attr( $layout ).' '.esc_attr( $show_on ); ?>"><?php
...
?></ul>
<style>
	<?php include('css/layout_4_css.php'); ?>
</style>
<?php
if($show_on=='quarter'){
if ($link != '') { ?>
...
(function($) {
	$(function() {
		$("#scroller_layout_4").simplyScroll();
	});
})(jQuery);
</script>
<?php } ?>