...
<div class="container">
  <?php if(pionusnews_get_option('pionusnews_on_breadcrumbs') == 1) { ?>
	...
	<div class="inner-content <?php if (has_post_thumbnail()) : ?> no-padding<?php endif;?> single-without-sidebar">
	...
	<?php endif; ?>
	<?php endif; ?>
		<div class="container <?php if (has_post_thumbnail()) : ?> onlytop70 <?php endif; ?>">

			<div class="row">
				<div class="<?php if (has_post_thumbnail()) : ?>col-md-8 col-md-offset-2<?php else: ?>col-md-12<?php endif; ?>">
				
					<div class="blog-single the-border-wrapper">
						<?php
							if ( has_post_format( 'video' ) ) :
							 echo get_first_video_embed(get_the_ID()); 
						 ?>
						 <?php 
						if($category_Position==1){
						if ( has_category() ) { ?>
							<div class="single-meta single-meta2 margin-bottom-50">
								...
								<?php echo pionusnews_category_styles(); ?>
							</div>
						<?php } } ?>
					...
					<!--BEGIN .author-bio-->
						...
						?>
						<div class="post-nav <?php if(pionusnews_get_option('pionusnews_show_author_on_single_post') != 1) { echo 'margintop20'; } ?>">
							<div class="row">
							<?php
							$prevPost = get_previous_post(true);
							$nextPost = get_next_post(true);
							...
							<div class="col-md-6 col-sm-6 col-xs-6 text-left">
								<a href="<?php the_permalink(); ?>"><i class="fas fa-angle-right"></i>
