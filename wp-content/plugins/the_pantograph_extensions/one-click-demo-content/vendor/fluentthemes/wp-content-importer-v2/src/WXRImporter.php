...
class WXRImporter extends \WP_Importer {
	...
	protected function fetch_remote_file( $url, $post ) {
		...
		// More info here: https://github.com/fluentthemes/WordPress-Importer/pull/2
		//
	...
	protected function post_exists( $data ) {
		...
		if ( $this->options['prefill_existing_posts'] ) {
			// OCDC: fix for custom post types. The guids in the prefilled section are escaped, so these ones should be as well.
