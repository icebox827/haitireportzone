        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    echo '<input type="hidden" class="upload" name="' . esc_attr( $this->field[ 'name' ] ) . '[' . esc_attr( $xv . '] )[image]' . esc_attr( $this->field['name_suffix'] ) .'" id="' . esc_attr( $this->field[ 'id' ] ) . '-image_url_' . esc_attr( $x ) . '" value="' . esc_attr( $slide[ 'image' ] ) . '" readonly="readonly" />';
            ...
            if ( $x == 0 ) {
                ...
                echo '<span class="button media_upload_button" id="add_' . esc_attr( $x ) . '">' . __ ( 'Upload', 'pantograph') . '</span>';
