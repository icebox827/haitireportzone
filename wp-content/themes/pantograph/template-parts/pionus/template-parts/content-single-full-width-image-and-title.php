...
<div class="inner-content <?php if (has_post_thumbnail()) : ?> no-padding<?php endif;?> single-full-width-image-and-title">
		<?php 
		...
		<div class="container 
		<?php 
		if((pionusnews_get_option('breaking_news_on_off') == 0) || (pionusnews_get_option('pionusnews_on_breadcrumbs') == 0)) { 
