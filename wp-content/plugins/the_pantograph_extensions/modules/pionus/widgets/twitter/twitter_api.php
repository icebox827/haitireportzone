...
class FTTwitterAPIExchange
{
    ...
    public function __construct(array $settings)
    {
        ...
        {
            throw new RuntimeException('FTTwitterAPIExchange requires cURL extension to be loaded, see: http://curl.haxx.se/docs/install.html');
        }
        ...
        {
            throw new InvalidArgumentException('Incomplete settings passed to FTTwitterAPIExchange');
        }
     ...
     *
     * @return FTTwitterAPIExchange Instance of self for method chaining
     */
