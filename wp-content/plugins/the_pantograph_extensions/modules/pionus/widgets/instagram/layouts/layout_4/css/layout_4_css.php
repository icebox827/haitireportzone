...
.pionusnews_instagram ul.instagram-photo-size-thumbnail.layout_4.quarter li a img:hover,
.pionusnews_instagram ul.instagram-photo-size-thumbnail.layout_4.quarter li a:hover img{
	height: 99px;
}
';
}
