	 ...
	 <?php if(pionusnews_get_option('pionusnews_on_breadcrumbs') == 1) { ?>
		...
		<div class="row conditional-margin">
			<div class="col-md-8 col-sm-12">
				...
				?>
					<div class="blog-single <?php if (!has_post_thumbnail()) : ?> no-single-image the-border-wrapper<?php endif; ?>">
					<?php if ( !has_post_format( 'video' ) ) : ?>
					<?php if((!empty($get_image))){ ?>
						<article class="style3"<?php if(pionusnews_get_option('pionusnews_post_border') == '1'){ ?> style="margin-bottom:0 !important;"<?php } ?>>
						...
						<?php endif; ?>
						<?php endif; ?>
						<div class="<?php if(has_post_thumbnail()){ ?>the-border-wrapper<?php } ?>"><!--Border Wrapper Start-->
